...
class MeituanBot:
    ...
    def _open_and_reply(self, page: Page, item: Any, expected_customer: str = "", expected_card_text: str = "") -> None:
        ...
        # to MAX_SAME_REPLY (3) times. Different replies are always allowed.
        # This prevents infinite re-send of identical content while still
        # replying once to every customer message (one-for-one).
        MAX_SAME_REPLY = 3
