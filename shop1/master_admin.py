...
function logsHtml(logs){logs=logs||{};return `<div class="card"><h3>运行日志</h3><div class="grid"><div class="card third" style="margin:0"><h3>主管理台</h3><div class="logbox">${esc(logs.master||'暂无日志')}</div></div><div class="card third" style="margin:0"><h3>北三环路一段店 Bot</h3><div class="logbox">${esc(logs.shop1_bot||'暂无日志')}</div></div><div class="card third" style="margin:0"><h3>人民南路一段店 Bot</h3><div class="logbox">${esc(logs.shop2_bot||'暂无日志')}</div></div></div></div>`}
